...
# --------------------------------------------------------------------------------------
# Prompt and tools: the production objects themselves
# --------------------------------------------------------------------------------------

# Imported rather than mirrored: a copy of the prompt drifts from the one that ships, and
# then the eval no longer describes production behaviour.
